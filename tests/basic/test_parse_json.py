...
```
    ...
    with pytest.raises(BadAIJsonAnswer): parse_json('qq{')
    with pytest.raises(BadAIJsonAnswer): parse_json('qwe{}}')
    with pytest.raises(BadAIJsonAnswer): parse_json('')
    with pytest.raises(BadAIJsonAnswer): parse_json('}{')
